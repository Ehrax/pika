...
final class InvoiceRecord {
    ...
    init(
        ...
        businessSenderTaxLegalFieldsData: String = "",
        selectedPaymentMethodData: String = "",
        businessTaxNote: String = "",
        clientName: String = "",
        clientEmail: String = "",
        clientBillingAddress: String = "",
        clientRecipientTaxLegalFieldsData: String = "",
        projectName: String = "",
        bucketName: String = "",
        createdAt: Date = .now,
        updatedAt: Date = .now,
        ...
        self.businessSenderTaxLegalFieldsData = businessSenderTaxLegalFieldsData
        ...
        self.clientRecipientTaxLegalFieldsData = clientRecipientTaxLegalFieldsData
