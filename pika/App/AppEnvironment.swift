...
struct AppEnvironment: Equatable {
    static let environmentNameInfoDictionaryKey = "PIKA_ENVIRONMENT_NAME"
    static let cloudKitContainerIdentifierInfoDictionaryKey = "PIKA_CLOUDKIT_CONTAINER_IDENTIFIER"

    static let development = AppEnvironment(
        name: "dev",
        cloudKitContainerIdentifier: "iCloud.ehrax.dev.pika.dev"
    )
    static let production = AppEnvironment(
        name: "prod",
        cloudKitContainerIdentifier: "iCloud.ehrax.dev.pika"
    )
