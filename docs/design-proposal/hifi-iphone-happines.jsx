...
function HiFi_PhoneD1({ theme }) {
  const projects = [
    { name: 'mariage-lea-tom', dot: '#6B7BFF', meta: '4 buckets · 38 pcs', amt: '€1’190', state: 'ready' },
    { name: 'boutique-la-trame', dot: '#7AC79A', meta: '2 buckets · 14 pcs', amt: '€590', state: 'overdue' },
    { name: 'marche-noel-2026', dot: theme.textMuted, meta: '1 bucket · 8 pcs', amt: '€280', state: null },
  ];
  return (
...
function HiFi_PhoneD2({ theme }) {
  const buckets = [
    { name: 'Centerpieces', meta: '12 pcs · €420', state: 'open' },
    { name: 'Wedding favors', meta: '8 pcs · €105', state: 'open' },
    { name: 'Bridal bouquet', meta: '24 pcs · €1260', state: 'ready' },
    { name: 'Materials & shipping', meta: '6 items · €126', state: 'open', kind: 'fixed' },
    { name: 'Engagement set — invoiced', meta: 'HIN-2026-001', state: 'finalized' },
  ];
  return (
    <PhoneCanvas theme={theme}>
      <PhoneLargeTitle theme={theme} back="projects" sub="mariage-lea-tom · €35/pc"
...
function HiFi_PhoneD3({ theme }) {
  const days = [
    { date: 'Apr 26 · today', items: [
      { range: '14:30–15:00', dur: '0.5 h', desc: 'studio cleanup', nb: true },
    ]},
    { date: 'Apr 24', items: [
      { range: '14:00–16:30', dur: '2.5 h', desc: 'centerpiece · arrangement #4', amt: '€140' },
      { range: '10:00–12:00', dur: '2.0 h', desc: 'photo session · spring catalog', amt: '€70' },
    ]},
    { date: 'Apr 23', items: [
      { range: '13:30–17:00', dur: '3.5 h', desc: 'ribbon trim · cream silk · 24 m', amt: '€105' },
      { range: '09:00–12:30', dur: '3.5 h', desc: 'ivory vase · throwing', amt: '€105' },
    ]},
  ];
  return (
    <PhoneCanvas theme={theme}>
      <PhoneNav theme={theme} title="Centerpieces" back="buckets" right="···" />
      <div style={{ padding: '4px 20px 16px', flex: '0 0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
          <div>
            <HFNum theme={theme} size={32} weight={700}>€420</HFNum>
            <div style={{ fontSize: 12, color: theme.textMuted, marginTop: 2, fontFamily: HF_FONT_NUM }}>12 pcs · 1 in progress</div>
          </div>
    ...
    <div style={{
      ...
      <div style={{ opacity: 0.35, pointerEvents: 'none', flex: '0 0 auto' }}>
        ...
        <div style={{ padding: '4px 20px 16px' }}>
          <HFNum theme={theme} size={32} weight={700}>€420</HFNum>
          <div style={{ fontSize: 12, color: theme.textMuted, marginTop: 2, fontFamily: HF_FONT_NUM }}>12 pcs · €35/pc</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, flex: '0 0 auto' }}>
          ...
          <div style={{
            ...
            <HFNum theme={theme} size={18} weight={600} color={theme.accent}>€70.00</HFNum>
          </div>
      ...
      <div style={{ padding: '8px 20px 24px', flex: 1, overflow: 'auto' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
            ...
            <span style={{ flex: 1 }} />
            <span style={{ fontFamily: HF_FONT_NUM, fontSize: 11, color: theme.textMuted }}>12 pcs + €85 materials</span>
          </div>
          <HFNum theme={theme} size={36} weight={700} color={theme.success}>€855.00</HFNum>
        ...
        <div style={{
          ...
          {[
            ['10:00–12:00', '2.00 h', '€70'],
            ['14:30–15:00', '0.50 h', 'n/b'],
            ['14:00–16:30', '2.50 h', '€140'],
            ['09:00–12:30', '3.50 h', '€105'],
            ['13:30–17:00', '3.50 h', '€105'],
          ].map((r, i, a) => (
            <div key={i} style={{
              display: 'grid', gridTemplateColumns: '92px 1fr 60px',
    ...
    <PhoneCanvas theme={theme}>
      ...
      <div style={{ padding: '0 20px', display: 'flex', flexDirection: 'column', gap: 14, flex: 1, overflow: 'auto', paddingBottom: 20 }}>
        ...
        <div style={{
          ...
          <HFNum theme={theme} size={34} weight={700}>€1’850</HFNum>
          <div style={{ fontSize: 12, color: theme.textMuted, marginTop: 4 }}>
            <span style={{ color: theme.danger }}>€590 overdue</span> · 2 invoices
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <div style={{ background: theme.surfaceAlt, borderRadius: 12, border: `1px solid ${theme.border}`, padding: 14 }}>
            ...
            <HFNum theme={theme} size={20} weight={600} color={theme.accent}>€1’090</HFNum>
          ...
          <div style={{ background: theme.surfaceAlt, borderRadius: 12, border: `1px solid ${theme.border}`, padding: 14 }}>
            ...
            <HFNum theme={theme} size={20} weight={600}>€2’840</HFNum>
            <div style={{ fontSize: 11, color: theme.success, fontFamily: HF_FONT_NUM }}>+€480</div>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ background: theme.surfaceAlt, borderRadius: 12, border: `1px solid ${theme.border}`, overflow: 'hidden' }}>
            {[
              { tone: 'overdue', primary: 'HIN-2026-002', meta: 'la-trame · +6 d', amt: '€590' },
              { tone: 'ready',   primary: 'Centerpieces',          meta: 'lea-tom · 11.5 h', amt: '€505' },
              { tone: 'ready',   primary: 'Spring drop',           meta: 'la-trame · 6.0 h',  amt: '€590' },
            ].map((r, i, a) => (
              <div key={i} style={{
                display: 'flex', alignItems: 'center', gap: 10,
                padding: '13px 14px',
        ...
        <div>
          ...
          <div style={{
            ...
            <HFField theme={theme} value="lea-tom · MVP" prefix="◇" />
