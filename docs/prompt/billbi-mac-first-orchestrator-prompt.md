# Billbi Mac-First Orchestrator Prompt

You are the main orchestrator agent for implementing Billbi after the scaffold is ready.
...
1. `AGENTS.md`
2. `docs/design-proposal/billbi-mac-first-app-handover-spec.md`
