...
function MacShell({ children, theme, active = 'projects' }) {
  return (
    <div style={{ display: 'flex', width: '100%', height: '100%', minHeight: 0 }}>
      <HFSidebar theme={theme} active={active} />
...
function BucketList({ theme, selected = 'mvp' }) {
  const buckets = [
    { id: 'mvp', name: 'MVP', meta: '12.5 h · €1’000', state: 'open' },
    { id: 'maint', name: 'Maintenance', meta: '3.0 h · €240', state: 'open' },
    { id: 'dash', name: 'Customer dashboard', meta: '6.5 h · €520', state: 'open' },
    { id: 'fixed', name: 'Infra fixed costs', meta: '2 items · €84', state: 'open', kind: 'fixed' },
    { id: 'q1', name: 'Q1 — invoiced', meta: 'EHX-2026-001', state: 'finalized' },
  ];
  return (
    <div style={{
  ...
  const projects = [
    {
      ...
      dot: '#6B7BFF',
      meta: '4 buckets · started Mar 18 · €80/h',
      total: '€1’760',
      counts: { open: 2, ready: 1, finalized: 1 },
      attention: { tone: 'ready', text: 'MVP ready · €970' },
    },
    {
      name: 'helvetia-tools',
      dot: '#7AC79A',
      meta: '2 buckets · started Feb 02 · €80/h',
      total: '€480',
      counts: { open: 1, ready: 0, finalized: 1 },
      attention: { tone: 'overdue', text: 'EHX-002 overdue +6 d' },
    },
    {
      name: 'ehrax-internal',
      dot: theme.textMuted,
      meta: '1 bucket · started Jan 04 · n/b',
      total: '€240',
        ...
        <div style={{ flex: 1, padding: '24px 32px', overflow: 'auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            <div>
              ...
              <div style={{ color: theme.textSecondary, fontSize: 13, marginTop: 4 }}>
                <HFNum theme={theme} size={13}>€2’480</HFNum> open · <HFNum theme={theme} size={13} color={theme.success}>€1’450</HFNum> ready · <HFNum theme={theme} size={13} color={theme.danger}>€480</HFNum> overdue
              </div>
            </div>
          ...
          <div>
            ...
            <HFCard theme={theme} padding={0}>
              {[
                ['Today 14:30', 'bikepark · MVP', 'standup logged · 0.5 h'],
                ['Today 12:00', 'bikepark · MVP', '2.0 h logged · review w/ Adi'],
                ['Yesterday',   'helvetia · Q1', 'invoice EHX-2026-001 marked paid'],
              ].map((r, i, a) => (
                <div key={i} style={{
...
function HiFi_MacA2({ theme }) {
  const entries = [
    { date: 'Apr 23', range: '09:00–12:30', dur: 3.5, desc: 'API spec · auth + token rotation' },
    ...
    { date: 'Apr 24', range: '14:00–16:30', dur: 2.5, desc: 'map tiles + clustering' },
    ...
    <HFWindow theme={theme}>
      <MacShell theme={theme} active="projects">
        <HFTopBar theme={theme} right={
          ...
          <span style={{ color: theme.textMuted, fontSize: 13 }}>bikepark-thunersee</span>
          <span style={{ color: theme.textMuted }}>/</span>
          <span style={{ fontSize: 13, fontWeight: 500 }}>MVP</span>
        </HFTopBar>
        ...
        <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
          ...
          <div style={{ flex: 1, padding: '24px 32px', overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 24 }}>
              <div>
                <div style={{ fontSize: 24, fontWeight: 600, letterSpacing: -0.4, marginBottom: 6 }}>MVP</div>
                <div style={{ color: theme.textSecondary, fontSize: 13 }}>bikepark-thunersee · rate <HFNum theme={theme} size={13}>€80/h</HFNum></div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <HFNum theme={theme} size={28} weight={600}>€760</HFNum>
                <div style={{ fontSize: 11, color: theme.textMuted, marginTop: 2, fontFamily: HF_FONT_NUM }}>9.5 h · adding…</div>
              </div>
            </div>
            ...
            <div>
              ...
              <HFCard theme={theme} padding={0}>
                ...
                {[
                  ['Apr 23', '09:00–12:30', 'API spec · auth + token rotation', 3.5],
                  ['Apr 23', '13:30–17:00', 'routes · bookings list endpoint', 3.5],
                  ['Apr 24', '14:00–16:30', 'map tiles + clustering', 2.5],
                ].map((e, i) => (
                  <div key={i} style={{
                    display: 'grid', gridTemplateColumns: '64px 110px 1fr 60px 80px',
                ...
                <div style={{
                  ...
                  <HFNum theme={theme} size={13} weight={500} color={theme.textMuted}>€160</HFNum>
                </div>
      ...
      <MacShell theme={theme} active="dashboard">
        ...
        <div style={{ flex: 1, padding: '28px 32px', overflow: 'auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            <HFKpi theme={theme} label="Outstanding" value="€2’080" sub="2 invoices" />
            <HFKpi theme={theme} label="Overdue" value="€480" sub="helvetia · +6 d" tone="danger" />
            <HFKpi theme={theme} label="Ready to invoice" value="€1’450" sub="2 buckets" tone="accent" />
            <HFKpi theme={theme} label="This month" value="€3’240" sub="+€620 vs March" />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 20, flex: 1, minHeight: 0 }}>
            ...
            <HFCard theme={theme} padding={0}>
              ...
              {[
                { tone: 'overdue', primary: 'EHX-2026-002 · helvetia-tools', meta: 'overdue · +6 d', amt: '€480', cta: 'send reminder' },
                { tone: 'ready', primary: 'MVP · bikepark-thunersee', meta: '11.5 h + €50 fixed', amt: '€970', cta: 'create invoice' },
                { tone: 'ready', primary: 'helvetia-tools · Q1', meta: '6.0 h', amt: '€480', cta: 'create invoice' },
                { tone: 'finalized', primary: 'EHX-2026-003 · ehrax-internal', meta: 'finalized · not sent', amt: '€600', cta: 'mark sent' },
                { tone: 'sent', primary: 'EHX-2026-001 · bikepark', meta: 'due in 3 d', amt: '€1’600', cta: 'mark paid' },
              ].map((r, i, a) => (
                <div key={i} style={{
            ...
            <HFCard theme={theme}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
                <div>
                  ...
                  <HFNum theme={theme} size={28} weight={600} style={{ display: 'block', marginTop: 6 }}>€32’480</HFNum>
          ...
          <div style={{
            ...
            <div style={{ padding: '20px 24px', borderBottom: `1px solid ${theme.border}`, display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              <div>
                ...
                <div style={{ fontSize: 12, color: theme.textMuted, marginTop: 2 }}>MVP · bikepark-thunersee · 11.5 h + 1 fixed cost</div>
              </div>
              <span style={{ color: theme.textMuted, fontSize: 16, cursor: 'default' }}>×</span>
            </div>
            <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <HFField theme={theme} label="Recipient" value="bikepark Thunersee AG" prefix="◇" />
                <HFField theme={theme} label="Invoice number" value="EHX-2026-004" suffix="auto" monospace />
              </div>
              ...
              <div style={{
                ...
                <TotalRow theme={theme} label="11.5 h × €80" amt="€920.00" />
                <TotalRow theme={theme} label="Infrastructure · fixed" amt="€50.20" />
                <div style={{ height: 1, background: theme.border, margin: '8px 0' }} />
                <TotalRow theme={theme} label="Total" amt="€970.20" big />
              </div>
            </div>
    ...
    <HFWindow theme={theme}>
      <MacShell theme={theme} active="invoices">
        <HFTopBar theme={theme} right={
          ...
          <span style={{ color: theme.textMuted }}>/</span>
          <span style={{ fontFamily: HF_FONT_NUM, fontSize: 13, fontWeight: 500 }}>EHX-2026-004</span>
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '380px 1fr', minHeight: 0, background: theme.bg }}>
          ...
          <div style={{ padding: 24, overflow: 'auto', borderRight: `1px solid ${theme.border}`, background: theme.surface, display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div>
              ...
              <HFNum theme={theme} size={32} weight={700}>€970.20</HFNum>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, fontWeight: 500, marginBottom: 2 }}>bikepark Thunersee AG</div>
          ...
          {/* Right PDF preview */}
          <div style={{ padding: 28, overflow: 'auto', background: theme.bg, display: 'flex', justifyContent: 'center' }}>
...
function PDFPreview({ theme }) {
  return (
    <div style={{
      width: 540, minHeight: 760,
      background: '#FFFFFF',
      color: '#0A0A0B',
      boxShadow: '0 12px 40px #0006, 0 1px 0 #ffffff10 inset',
      padding: '48px 56px',
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 36 }}>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ fontFamily: HF_FONT_NUM, fontSize: 10, color: '#52525B', marginTop: 4 }}>EHX-2026-004</div>
        </div>
      </div>
      {/* Bill to / dates */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 24, marginBottom: 32 }}>
        <div>
          ...
          <div style={{ fontSize: 11, fontWeight: 500 }}>bikepark Thunersee AG</div>
        ...
        <div>
          ...
          <div style={{ fontSize: 11 }}>MVP</div>
          <div style={{ fontSize: 10, color: '#52525B', marginTop: 2 }}>bikepark-thunersee</div>
        </div>
      </div>
      {/* Line items */}
      <div style={{ borderTop: '1px solid #0a0a0b', paddingTop: 12, marginBottom: 24 }}>
        ...
        <PDFRow desc="Engineering · API + routes + map tiles" qty="11.50 h" rate="€80.00" amt="€920.00" />
        <PDFRow desc="Infrastructure · Fly.io + R2 (April)" qty="1" rate="€50.20" amt="€50.20" />
      </div>
      {/* Totals */}
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 28 }}>
        <div style={{ width: 240 }}>
          <PDFTotal label="Subtotal" amt="€970.20" />
          <PDFTotal label="VAT" amt="—" muted />
          <div style={{ borderTop: '1px solid #0a0a0b', paddingTop: 10, marginTop: 10 }} />
          <PDFTotal label="Total due" amt="€970.20" big />
        </div>
      </div>
      {/* Payment */}
