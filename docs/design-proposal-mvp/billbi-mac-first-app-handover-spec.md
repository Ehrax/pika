...
- `docs/design-proposal/Billbi Hi-Fi.html`
- `docs/design-proposal/Billbi Wireframes.html`
- `docs/design-proposal/Billbi Wireframes-print.html`
...
Billbi must be usable immediately for a freelancer to:
