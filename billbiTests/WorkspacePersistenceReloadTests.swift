...
struct WorkspacePersistenceReloadTests {
    ...
    @Test func persistentWorkspaceStoreRejectsDuplicateLocalInvoiceNumbers() throws {
        ...
        let existingInvoice = InvoiceRecord(
            ...
            businessPaymentDetails: "IBAN DE02 1001 1001 2125 8144 33",
    ...
    @Test func persistentWorkspaceStoreReloadsAndThrowsConflictForStaleInvoiceFinalization() throws {
        ...
        let issueDate = Date.billbiDate(year: 2026, month: 5, day: 3)
        let dueDate = Date.billbiDate(year: 2026, month: 5, day: 17)
    ...
    @Test func persistentWorkspaceStoreFinalizesLatestDurableBucketInputs() throws {
        ...
        let issueDate = Date.billbiDate(year: 2026, month: 5, day: 5)
        let dueDate = Date.billbiDate(year: 2026, month: 5, day: 19)
    ...
    @Test func persistentWorkspaceStoreReloadsAndThrowsConflictForStaleInvoiceNumberDuplicate() throws {
        ...
        let dueDate = Date.billbiDate(year: 2026, month: 5, day: 18)
    ...
    @Test func persistentWorkspaceStoreSerializesBucketFinalizationAcrossContexts() throws {
        ...
        let issueDate = Date.billbiDate(year: 2026, month: 5, day: 6)
        let dueDate = Date.billbiDate(year: 2026, month: 5, day: 20)
        let seededWorkspace = WorkspaceSnapshot(
    ...
    @Test func persistentWorkspaceStoreBuildsProjectionFromNormalizedRecords() throws {
        ...
        let workDate = Date.billbiDate(year: 2026, month: 4, day: 20)
        let issueDate = Date.billbiDate(year: 2026, month: 4, day: 25)
        let dueDate = Date.billbiDate(year: 2026, month: 5, day: 9)
    ...
    @Test func persistentWorkspaceProjectionSortingIsDeterministic() throws {
        ...
        let createdAt = Date.billbiDate(year: 2026, month: 4, day: 22)
    ...
    @Test func persistentWorkspaceArchiveExportEncodesV1WithoutRecordFieldLeakage() throws {
        ...
        let exportedAt = Date.billbiDate(year: 2026, month: 5, day: 2)
        let issuedAt = Date.billbiDate(year: 2026, month: 5, day: 1)
        let dueAt = Date.billbiDate(year: 2026, month: 5, day: 15)
        ...
        #expect(decoded.generator?.app == "billbi-tests")
