...
struct WorkspaceArchiveActionsTests {
    ...
    @Test func exportDestinationPreservesExistingArchiveExtensionCaseInsensitively() {
        let selectedURL = URL(filePath: "/tmp/workspace-2026-05-02.BILLBIARCHIVE")
    ...
    @Test func preImportBackupWritesV1ArchiveInAppSupportBackupsDirectory() throws {
        ...
        let now = Date.billbiDate(year: 2026, month: 5, day: 2)
        ...
        let backupsDirectory = try WorkspaceArchiveActions.workspaceBackupsDirectoryURL(
            fileManager: fileManager,
            appSupportDirectoryURL: appSupportRoot
        )
    ...
    @Test func revealWorkspaceBackupsCreatesDirectoryAndOpensIt() throws {
        ...
        let directoryURL = appSupportRoot
            ...
            .appending(component: AppEnvironment.development.name, directoryHint: .isDirectory)
            .appending(component: "ehrax.dev.billbi.dev", directoryHint: .isDirectory)
