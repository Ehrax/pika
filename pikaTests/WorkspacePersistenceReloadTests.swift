...
struct WorkspacePersistenceReloadTests {
    ...
    @Test func persistentWorkspaceArchiveExportEncodesV1WithoutRecordFieldLeakage() throws {
        ...
        #expect(decoded.format == WorkspaceArchiveEnvelope.v1Format)
        #expect(decoded.version == WorkspaceArchiveEnvelope.v1Version)
        #expect(decoded.workspace.businessProfile.id == profileID)
